...
In the previous chapter we stated theories in \FOF. 
Table \ref{tab:presburger:axioms:clauses} shows all the axioms translated into clausal normal form.
...
\begin{table}[hbt]	
	...
	\tag*{induction schema}
	\end{align*}
	\caption{Clausal axioms and induction schema for Presburger arithmetic}
...
\begin{table}[hbt]	
	\begin{gather*}
	0+0\mNE 0
	\lor\boxed{0+\mc_1\mEQ \mc_1}
	\lor 0+z\mEQ z
	\\
	0+0\mNE 0
	\lor\boxed{0+\msucc(\mc_1)\mNE \msucc(\mc_1)} 
	\lor 0+z\mEQ z
	\end{gather*}
