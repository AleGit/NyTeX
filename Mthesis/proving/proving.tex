...
In 1960 Paul Gilmore presented the first {\myem implementation} of a complete, 
i.e.~a proof will be found eventually for every valid formula, 
and automated theorem prover \cite{5392528} for first order logic without equality. 
...
InstGen introduces a new constant $\bot\not\in\mcF$
