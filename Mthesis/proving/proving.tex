...
such that eventually an unsatisfiable one is found for an arbitrary unsatisfiable set of clauses.
...
%		
		...
		\item\label{step:igl:clashes} We search for pairs of selected literals $(A, \lnot B)$
		such that $\tau = \mgu(A,B)$ exists.
