...
\DeclareMathOperator{\var}{\mathpzc{Vars}}			% set of variables of a term
\DeclareMathOperator{\fun}{\mathpzc{Funs}}			% set function symbols of a term
\DeclareMathOperator{\pos}{\mathpzc{Pos}}			% set of positions in a term
\DeclareMathOperator{\posT}{\mathpzc{{t-}Pos}}	    % set of positions in a term
\DeclareMathOperator{\PosStr}{\mathpzc{Pos^F}}      % set of position strings
\DeclareMathOperator{\vaPosStr}{\mathpzc{Pos^F_*}}  % set of variable agnostic positions strings
% \DeclareMathOperator{\posV}{\mathpzc{Pos^{\!V}}}
% \DeclareMathOperator{\occurs}{occurs}
\DeclareMathOperator{\fvar}{\mathpzc{Fvars}}		% set of free variables
\DeclareMathOperator{\bvar}{\mathpzc{Bvars}}        % set of bound variables
\DeclareMathOperator{\subformulae}{\mathpzc{Sf}}	% set of subformulae
...
\DeclareMathOperator{\head}{head}		% head of a position	
\DeclareMathOperator{\tail}{tail}		% tail of a position
\DeclareMathOperator{\length}{length}   % length of a position
...
\DeclareMathOperator{\size}{size} 		% size of a formula
% height of a formula
...
\newcommand{\Pf}{\text{\currency}} % generic symobol form signature, P,f,=
% \newcommand{\PfinF}{\Pf\in\mcF}

\newcommand{\connect}{*} % generic connective
\newcommand{\SetOfConnectives}{\{ \lor, \land, \rightarrow{}\} }

\newcommand{\quantify}{{\rotatebox[origin=c]{180}{\textsf{\AE}}}\!}
\newcommand{\SetOfQuantifiers}{\{ \forall, \exists{} \}}
...
\newcommand{\foxu}{\textcolor{colO}{\mcu}}
...
% \newcommand{\SNF}{\texttt{SNF}\xspace}
...
\newcommand{\bool}[1]{\ensuremath{{#1}_{\mathbb{B}}}}
\newcommand{\BTYPE}{\mathsf{BOOL}}
\newcommand{\UTYPE}{\mathsf{U}}
