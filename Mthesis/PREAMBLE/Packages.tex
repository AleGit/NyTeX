...
\usepackage{scrhack} %% avoid waring deprecated \float@addtolist
...
\usepackage{marvosym}
\usepackage{wasysym} % \currency (regular)
% \usepackage{textcomp} % \textcurrency (small)
...
\usepackage{tikz}
\input{PREAMBLE/Drawings}		% definitions and tikz macros
...
\usepackage{xspace}
\input{PREAMBLE/Operators.tex}
\input{PREAMBLE/Commands}		% complex macros
\input{PREAMBLE/Symbols}			% simple macros
%% ---------------------------------------------------------------------- %%
