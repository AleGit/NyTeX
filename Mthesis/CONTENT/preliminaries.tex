...
\noindent In Definition~\vref{def:semantics:atoms} we have interpreted the equality symbol as binary relation without restrictions.
This allows unwelcome models as in Example~\vref{ex:a:neq:a}.
...
\begin{lemma}A well-founded and total order on general ground terms always exists.\end{lemma}
	...
	\begin{definition}[Order on literals]
