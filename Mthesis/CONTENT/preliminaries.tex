...
\begin{remark}
	To show equisatisfiability of arbitrary formulae \( F \equisat G \) 
	...
	The goal is to transform \( F \) to \( F' \) such that \( F \equisat F' \)
	and satisfiability is “easier”
...
and demonstrate their usage in Example \vref{ex:equality:interpretation}.
