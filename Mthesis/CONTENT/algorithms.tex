...
may introduce unnecessary derivations from already considered literal pairings.
...
\begin{procedure}[Given clause algorithm with bookkeeping for \InstGen]
...
\subsection{Removal of redundant clauses}
...
\begin{proof}
	...
	\( S' \equisat S' \cup \{ \mcD \} \).
%
	Although clearly \( S'\bot\cup \{ \mcD\bot \} \entails S'\bot \)
...
\subsection{Retrieval clashing literals}

\subsection{Retrieval of unifiable subterms}
