...
\begin{definition}
	We define the set of variable agnostic position strings \(\vaPosStr(t)\)
		...
		\{ \ANGLES{\epsilon,*} \}
		& \text{if }t=x\in\SIGV \\
		\{ \ANGLES{\epsilon, \mf} \} \cup \{ \ANGLES{ip,s}\mid \ANGLES{p,s} \in\va	PosStr(t_i)\}
		&\text{if }t=\mf(t_1,\ldots,t_n)
		\end{cases}
		\end{gather*}
