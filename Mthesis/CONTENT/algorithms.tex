...
and check each clause (selected literal) for the desired qualities.
	...
	use cases and algorithms for the indexing and
	for a the fast retrieval of candidates for

	\begin{itemize}
		\item variants of a subset of the given clause
		\item clashing literals with the selected literal of the given clause
		\item unifiable subterms of literals with one side of the selected equation of the given clause
	\end{itemize}
