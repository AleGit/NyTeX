...
the those axioms in clausal normal form as in Tables 
\ref{tab:natural:numbers} and \ref{tab:addition:multiplication} for the natural numbers, additions, and multiplication.
