...
This does not hurt the saturation process badly, 
but we get an infinite sequence of generated instances starting with \( \axiom{I}_\msucc \) and \( \axiom{0}_\msucc \).
	\begin{gather*}
	\infer[ \sigma_0 ]{
