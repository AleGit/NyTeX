...
In this chapter we will discuss complete refuation proving procedures.
...
\section{Theory axioms in Clausal Normal Form}

In the previous chapter we expressed axioms and lemmas of first order theories in \FOF{} syntax,
but Gilmore's and other provers work on sets of clauses. 
...
We demonstrate the satisfiability transformation for the induction schema over \( G(x) \).
