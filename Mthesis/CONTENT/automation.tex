...
Second we efficiently transform the negated formula into an \coloremph{equisatisfiable} set of clauses
(e.g.~with Skolemization and Tseytin`s transformation~\cite{tseitin70}),
