\begin{tikzpicture}
    ...
    \node (ASYM) at (4,8) { asymmetric };
        ...
        \node (defSTP) at (-2,2.5) { $C\neq\square\Rightarrow C[s]\succ s$ };
        ...
        \node (TRAIRR) at (4,6) { $\bullet$ };
        \draw[->, dotted] (TRAIRR) -- (ASYM);
        \draw[->, dotted] (TRA) -- (TRAIRR);
        \draw[->, dotted] (IRR) -- (TRAIRR);
        \draw[->, dotted] (ASYM) edge [out=-60, in=150] (IRR);
