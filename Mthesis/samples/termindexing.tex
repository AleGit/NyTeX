...
\begin{example}{Variables (Normaalization)}
...
%+ SUBSTITUTIONTREES/Build+Index
\begin{example}{Substitutiontree Build}
...
%+ SUBSTITUTIONTREES/Retrieve+Index
\begin{example}{Substitutiontree Retrieve}
...
%% DISCRIMINATIONTREE/Build+Terms+Index
\begin{example}{Build}
...
%% DISCRIMINATIONTREE/Index
%% DISCRIMINATIONTREE/IndexEdges

%+ DISCRIMINATIONTREE/Retrieve+Terms+Index
\begin{example}{Retrieve}
...
%		\input{DISCRIMINATIONTREE/Index} 
		...
		\path[bend right, dashed, colN] (hfx) edge  (hfxx);
		\path[bend right, dashed, colN] (hf) edge  (hfha);
		\path[bend right, dashed, colN] (hfha) edge (hfhaa);
...
%% DISCRIMINATIONTREE/Subterms+Terms+Index
...
%%			\input{DISCRIMINATIONTREE/Index} 
			\input{samples/discriminationtreeindex}
			\node (hsubs) at (1,-4.5) {};
			\path[dashdotted, colN, sloped,above] (hsubs) 
