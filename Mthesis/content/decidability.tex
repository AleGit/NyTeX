...
\begin{definition}
	\coloremph{Infinity axioms} refers to the existence of satisfiable first order sentences without finite models.
	\end{definition}
...
\begin{definition}[Theory]
	...
	A theory is \coloremph{consistent} if the contradiction is not provable by its axioms.
	A theory is \coloremph{satisfiable} if there exists a model such thats its axioms hold
	in that model.
%
...
%
\begin{example}
A theory with axioms \( \forall x\,\mP(x) \) and \( \exists x\,\lnot\mP(x) \) 
would be neither consistent nor satisfiable. 
\end{example}
%
