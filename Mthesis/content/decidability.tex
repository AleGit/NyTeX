...
In Natural Deduction we start 
with a (possible empty) set of formulas -- the premises -- and infer other formulae -- the conclusions --
by using proof rules \cite{Huth:2004:LCS:975331}.
With $F_1,\ldots,F_n \proves G$ we claim that $G$ 
is in the transitive closure of inferable formulae of $\{ F_1,\ldots,F_n\}$.
(e.g.natural deduction proof to Lemma \vref{lemma:equivalence:congruence}).
