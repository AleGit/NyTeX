...
The last line states infinitely many induction axioms for arbitrary formulae $G$.
...
because the signature contains a binary function and the equality symbol.
The induction axiom translates to the following prenex normal form.
\[
	\exists x \forall y \left(
	\lnot G(0) \lor (G(x) \land \lnot G(x+1) \lor G(y)
	\right)
	\tag*{\PNF}
\]
\end{remark}
