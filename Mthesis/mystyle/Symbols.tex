...
\newcommand{\mEQ}{{\mathsf \approx}}
\newcommand{\mNE}{{\mathsf \not\approx}}
...
% signature, function and predicate symbols
...
\newcommand{\mcTfFV}{{\mcT_\mf(\mcF\!,\mcV)}}	% the set of function terms
\newcommand{\mcTPFV}{{\mcT_\mP(\mcF\!,\mcV)}}	% the set of predicate terms
