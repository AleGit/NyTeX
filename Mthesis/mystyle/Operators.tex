...
\DeclareMathOperator{\var}{\mathcal{V}\mathsf{ar}}			% variables of a term
\DeclareMathOperator{\fun}{\mathcal{F}\mathsf{un}}			% function symbols of a term
...
\DeclareMathOperator{\subterms}{terms}	
