...
\begin{definition}\label{def:syntax:PNF}
	\coloremph{negational prenex normal form}.
\end{definition}

\begin{definition}\label{def:syntax:PNF}
	\coloremph{conjunctive prenex normal form}.
\end{definition}

\begin{lemma}\label{lem:transformation:PNF}
...
\begin{lemma}\label{lem:quantifier:equivalences}
	\begin{align*}
