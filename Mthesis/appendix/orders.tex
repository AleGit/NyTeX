...
\begin{definition}
	A \coloremph{partial order} is a reflexive, transitive, and antisymmetric binary relation,
...
\begin{definition}
	A \coloremph{proper order} is a irreflexive and transitive binary relation,
...
\begin{definition}
	A \coloremph{total order} is a proper order where the following clause holds.
	\[
...
\begin{proof} We use resolution to derive asymmetry from irreflexivity and transitivity.
	\[
...
\begin{definition}
	A binary relation \( \supset \) is \coloremph{well-founded} on a set \( A \) if there is no infinite sequence
