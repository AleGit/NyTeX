...
\begin{definition}
	A clause $\mcC$ {\myem subsumes} a clause $\mcD$ if their exists a substitution $\theta$ such that $\mcC\theta \subseteq \mcD$,
	i.e.~clause $\mcD = \mcC\theta \lor \mcD'$ is a weakened instance of clause $\mcC$.
\end{definition}
%\begin{example}
