...
\begin{frame}
    ...
    \begin{abstract}
        The satisfiability of a set of ground instances of first order clauses is decidable.
        Instantiation-Based theorem proving uses this fact 
        by generating new clauses (more or less cleverly) that will eventually 
        conclude to a set of unsatisfiable ground instances if the clauses were indeed unsatisfiable.

        In most satisfiable cases an infinite number of ground instances exist.
