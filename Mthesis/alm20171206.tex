...
\begin{frame}{UP-Saturation}
        ...
        The UP-{saturation process} for $\mcL$ is a sequence \( \{ \mcL_i \}_{i=0}^\infty \)
...
\begin{itemize}
    ...
    \begin{itemize}
        \item $C_i=C'_i\cdot\sigma'_i, C'_i\in S$ for all $i\in 1\ldots k$
        \item $C\succC C_i$ for all $i\in 1\ldots k$
