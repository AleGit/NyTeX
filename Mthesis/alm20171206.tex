...
\begin{frame}{Completeness}
    ...
    \begin{proof}
        \begin{enumerate}
            ...
            \item Assumption that candidate is a not model\hfill\lightning
        \end{enumerate}
        \end{proof}
\end{frame}
...
\begin{frame}
    ...
    \begin{proof}
        ...
        \end{itemize}
        Hence we have $(s\mNE t)\tau\in I_{M\cdot\tau}$
...
\begin{frame}[allowframebreaks]
    ...
    \begin{itemize}
        ...
        which contradicts minimality.\hfill\lightning
    \end{itemize}
...
\right\}
    ...
    This is a contradiction.\hfill\lightning
    \vspace{0.7em}
