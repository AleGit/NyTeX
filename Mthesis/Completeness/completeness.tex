...
%
    ...
    % \begin{definition}The translated rules of unit superposition calculus:
    %     \begin{itemize}
    ...
    \begin{corollary}
        The can represent translated proofs in \InstGenEQ
        as proofs in unit paramodulation.
    \end{corollary}

    \begin{proof}
        We simulate derivation rules of \InstGenEQ
        with unit paramodulation for literals.
        \begin{align*}
        \infer[(\sigma)]
        {
            \infer[(\emptyset)]
