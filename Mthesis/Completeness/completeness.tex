...
\section{Reasoning on equational closures}\label{sec:reasoning:on:equational closures}
...
\end{remark}
   ...
   \begin{definition}[Unit superposition and resolution on closures~\cite{GK2004csl,CS2011PhD}, REC]\label{def:unit:superposition:on:closures}
    \begin{gather*}
        \infer[(\sigma)]
...
%
    ...
    \begin{definition}[Unit superposition and resolution on literals~\cite{GK2004csl,CS2011PhD}, REL]\label{def:unit:superposition:on:literals}
        \begin{gather*}
            \infer[(\sigma)]
    ...
    \section{Equational reasoning on predicates}\label{sec:equational:reasoning:on:predicates}
