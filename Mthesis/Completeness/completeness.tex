...
in Section~\vref{sec:inst:saturated:sets}
to present the completeness for saturated sets of closures
in a more untangled form than in the literature~\cite{GK2004csl}
% Section~\vref{sec:inst:saturation:process},
% Section~\vref{sec:inst:process:fairness}.


\section{Unit paramodulation}\label{sec:unit:paramodulation:closures}
...
\end{definition}
   ...
   \section{Saturation}\label{sec:saturation:strategies}
