...
In this chapter we introduce our simple automated theorem prover \verb|FLEA|
-- first order logic with equality theorem attester. It is 
-- as the reader may allready suspect --
a instantiation based theorem prover for first order clauses with equality.
