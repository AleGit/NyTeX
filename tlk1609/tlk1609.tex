...
\frame {
	\begin{itemize}
		...
		\begin{itemize}
			\item Linux, macOS
			\item Flex, Bison, Clang, Swift 3
			\item Yices
		\end{itemize}
		\item structure
		\begin{itemize}
			\item wrapper for yices, parsing, syslog, and some POSIX APIs
			\item data and algorithms
			\item strategy: sequential processing of growing list of clauses
		\end{itemize}
		\item optimizations
		\begin{itemize}
			\item indexing of selected literals
			\item indexing of clauses
			\item sharing of terms
		\end{itemize}
		\item in progress = missing
		\begin{itemize}
			\item alternative procedure for equality
			\item experiments
			\item written thesis
		\end{itemize}
	\end{itemize}
