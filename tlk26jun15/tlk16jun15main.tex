...
%	\lstinline|/// Create uninterpreted global (predicate) function `symbol` application|
%	\lstinline|/// with uninterpreted arguments `args` of implicit global type `free_type`|
%	\lstinline|/// and explicit return type `term_tau`:|
%	\lstinline|/// * `free_tau` - the symbol is a constant/function symbol|
%	\lstinline|/// * `bool_tau` - the symbol is a proposition/predicate symbol|
...
%	    	\lstinline|return yices_application(f, UInt32(args.count), args)|
%	    \lstinline|}
	\end{frame}
