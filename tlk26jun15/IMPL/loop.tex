...
\node (sl) [myrect, thick] at (8.5em,12.5em) {selected literals};
\node (us) [myrect,very thick, minimum width=8em, minimum height=3.5em, text width=7em] at (8.5em,8em) {search for\\clashing literals};
